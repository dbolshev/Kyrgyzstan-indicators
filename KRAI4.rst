######################################################################################################################################################
KRAI4. Закупка товаров методом прямого заключения договора по причине дозакупки товаров, если общая стоимость не превышает оговоренного в законе процента от проведенного конкурса, но цена и техническая спецификация не сохранены.
######################################################################################################################################################
...
5. Если стадия найденной процедуры ``data.tender.currentStage`` не равна ``contractSigned`` или ``evaluationComplete``, индикатор принимает значение ``-1``. Расчет заканчивается.
