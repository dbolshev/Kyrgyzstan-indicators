######################################################################################################################################################
KRAI4. Дозакупка товаров методом прямого заключения договора, если общая стоимость не превышает установленного законом процентного порога от ранее проведенного конкурса, но цена и техническая спецификация не сохранены.
######################################################################################################################################################
