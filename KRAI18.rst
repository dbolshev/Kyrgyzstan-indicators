...
1. Находим активный єлемент определения победителя ``data.awards.status = 'active'``.

2. Сравниваем дату ``data.awards.date`` из этого єлемента с датой объявления процедуры ``data.awards.date``.
