...
Риск не еффективной процедуры, качество поставляемых товаров может быть не адекватным. 
...
- ``dataqualificationRequirements.id``


Формула расчета
===============

1. Проверяем количество уникальных элементов в блоке ``dataqualificationRequirements``, таких, что имеют уникальные ``dataqualificationRequirements.id``.
