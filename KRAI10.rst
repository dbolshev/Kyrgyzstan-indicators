...
- Транзакционная переменная :ref:`tv_tenderCPVList`, :ref:`tv_badDataQuality`
...
6. Каждый элемент из :ref:`tv_tenderCPVList` исследуемой процедуры должен находиться в :ref:`tv_tenderCPVList` найденной процедуры. Иначе, индикатор принимает значение ``1``. Расчет заканчивается.
