...
Данная аналитическая таблица хранит все коды предметов закупок и даты объявления конкурсных процедур для каждой закупающей организации в текущем году.
...
======================== =========================== ======
Закупающая организация   Транзакционная переменная   Дата
------------------------ --------------------------- ------
Закупающая организация 1 Транзакционная переменная 1 Дата 1     
Закупающая организация 1 Транзакционная переменная 2 Дата 2
Закупающая организация 1 Транзакционная переменная 3 Дата 3
Закупающая организация 2 Транзакционная переменная 1 Дата 1
Закупающая организация 2 Транзакционная переменная 2 Дата 2
....                     ....
======================== =========================== ======
...
4. Из выбранных процедур берем их переменные :ref:`tv_tenderCPVList`. 
