...
3. Индикатор принимает значения ``1`` только для тех процедур, у которых ``data.qualificationRequirements.type`` имеют ровно 3 уникальных значения: ``Участники конкурса должны выполнить свои обязательства по уплате налогов в Кыргызской Республике``, ``Участники конкурса должны выполнить свои обязательства по уплате других обязательных платежей в Кыргызской Республике`` и ``Другое требование``. Во всех остальных случаях индикатор принимает значение ``0``.
