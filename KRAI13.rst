...
1. В исследуемой процедуре находим все объекты выбора победителя ``data.award`` такие, у которых ``data.award.status = 'active'``.

2. Выбираем суммы из этих объектов ``data.award.value.amount``. Суммируем все найденные суммы.
