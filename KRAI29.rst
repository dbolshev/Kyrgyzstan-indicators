...
3. Если количество предложений меньше 4, индикатор принимает значение ``0`` и расчет заканчивается.
...
5. Если количество определений победителя меньше, чем количество предложений, индикатор принимает значение ``0`` и расчет заканчивается.
