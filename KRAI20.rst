...
- находятся в статусе ``contractSigned`` 30 дней и более.
...
3. Из аналитической таблицы выбираем все строки для нашей закупающей организации, где  позднее, но не более чем на 30 дней, чем дата публикации из пункта 2.
